...
<body style="margin-top: 70px;">
  <section class="background" style="background-image: url('img/background.png');">
    ...
    <div class="col-sm-4" style="margin-top: 40px;">
        <form>
          <input type="button" class="btn btn-warning" style="color: black;" value="Edit informations" onclick="window.location.href='./editparent.php'" />
        </form>
    </div>
    <div class="row">
      <div class="col-sm-12">
        <h3 class="titreform">Mes enfants</h3>
<?php
      ...
      ?> 
      <form>
                  <input type="button" class="btn btn-warning" style="color: black;" value="Ajouter un enfant" onclick="window.location.href='./editparent.php'" />
                  </form>
                  <hr>
      </div>
      ...
      <thbody>
        <tr>
          <div class="row">
            ...
            <th class="col-xs-1">Nounou</th>
            <th class="col-xs-1">Revenu</th>
            <th class="col-xs-1">Jour(s)</th>
...
foreach ($nounou as $value) {
  echo "<tr class='even'>";
        ...
        echo "<td class='col-xs-2'>".$value[id_nounous]."</td>";
...
<input type="button" class="btn btn-warning" style="color: black;" value="Ajouter un service" onclick="window.location.href='./service.php'" />
</form>
<hr>
    </div>
